...
* **?[hive-queen](hive_queen)** is an idepodent scaffolding tool for creating hive websites based on a JSON configuration file. 
* **?[hive-model](hive_model)** is a memory model class, suitable for basic unit test/mocking or for resource management. 
* **?[hive-model-mongoose](hive_model_mongoose)** is a hive-model API compliant overlay for mongoose.